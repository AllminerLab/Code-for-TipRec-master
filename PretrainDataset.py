                ...
                for key in self.use_info_key:
                    if key in info:
                        if key == 'categories':
                            ...
                            contents.append(f'{key} is "{category}"')
                        elif key == 'brand':
                            brand = info[key]
                            ...
                            contents.append(f'{key} is "{brand}"')
                        elif key == 'price':
                            price = info[key]
                            ...
                            contents.append(f'{key} is "{price}"')
                        elif key == 'description':
                            description = ' '.join(info[key].split()[:50])
                            lines.append(f'"{key}": "{description}"')
                            contents.append(f'{key} is "{description}"')
                        elif key == 'attributes':
                            attr_text = info[key]
                            if attr_text:
                                lines.append(f'"{key}": "{attr_text}"')
                                contents.append(f'{key} is "{attr_text}"')
                            else:
                                continue
                        elif key == 'salesRank':
                            salesRank = info[key]
                            ...
                            contents.append(f'{key} is "{salesRank}"')
                        else:
                            value = info[key]
                            if value in (None, ''):
                                continue
                            lines.append(f'"{key}": "{value}"')
                            contents.append(f'{key} is "{value}"')
                if len(lines) == 0:
                    continue   
                one_sample['content'] = ',\n'.join(lines)
